...
import com.android.genericLibrary.BaseClass;
...
public class sanityPlaystoreBuildTest extends BaseClass {
	...
	public void camFunctionsTest() throws Throwable {
		...
		aLib.findScrollable(driver, eLib.getDataFromExcel("FileManager", 1, 0));
